...
- Copy, modify, merge, publish, distribute, sublicense, or sell any portion of the Software.
- Create derivative works based on the Software.
- Use the art, music, sound effects, gameplay design, story, characters, or any
  intellectual property included in this repository.
- Re-upload this project or any of its contents to any platform or repository.

This license does NOT grant you any rights to the game, its assets, its name,
its branding, or its intellectual property.

Any unauthorized use of the Software or its assets is strictly prohibited and
